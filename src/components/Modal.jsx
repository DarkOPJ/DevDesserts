...
const Modal = ({modalControl}) => {
  return (
    <dialog ref={modalControl} className="dialog container sm:w-[375px] backdrop:bg-black/50 p-7 rounded-lg">
      <svg
        width="30"
        height="30"
        viewBox="0 0 48 48"
      ...
      <h1 className="text-3xl font-bold mt-3 mb-1">Order Confirmed</h1>
      <p className="text-sm text-slate-500 font-semibold mb-6">We hope you enjoy your food!</p>

      {/* Added To Cart Products */}
      <AddedProducts isModal={true}>
        {/* Order Total */}
        <OrderTotal padding={"pt-3"} normalText={'text-xs'} largeText={'text-xl'}/>
      </AddedProducts>

      {/* Button */}
      <CremeBtn btnText={"Start New Order"} modalControl={modalControl}/>
    </dialog>
  )
}
