...
const Cart = ({modalControl}) => {
    ...
    return (
        <div className="bg-white p-5 sm:mx-auto rounded-xl h-fit md:w-auto xl:w-full w-full">
            <h2 className="text-creme font-bold text-2xl pb-2">Your Cart ({cart.length})</h2>

            {
                (!cart.length) ? 
                    <div className='py-3 mx-auto w-fit'>
                        <img src="./svgs/illustration-empty-cart.svg" alt="" />
                        <p className='text-xs text-cremeDark'>Your items will be added here</p>
                    </div>
                :   <div>
                        {/* Products */}
                        ...
                        {/* Order Total */}
                        <OrderTotal padding={'py-4'} normalText={'text-sm'} largeText={'text-2xl'}/>
